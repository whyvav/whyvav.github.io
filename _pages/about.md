...
<div class="notice--warning" style="display: flex; align-items: center; gap: 1.2em; padding: 1em 1.5em;">
  <img src="/images/under_construction.gif" alt="" style="height: 90px; flex-shrink: 0;">
  <div>
    <p style="margin: 0 0 0.4em; font-size: 1.1em; text-align: center;"><strong>🚧 Site Under Construction 🚧</strong></p>
    <p style="margin: 0;"><em>Some information on this site may be incomplete, inaccurate, or confidently wrong: <br>
    not unlike a draft paper before peer review. Excuse the mess while excavation is in progress.</em></p>
  </div>
</div>
